...
- `watcher.py:94-133` (`_route_urgent_or_digest`); `email_alerts.py:103-129` (`format_digest_body`'s `urgent_recap` section); `email_alerts.py:176-212` (`send_email`'s `bool` return)
- policy
